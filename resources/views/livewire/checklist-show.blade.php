        ...
        @if (!is_null($current_task))
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @else
                        <a wire:click.prevent="toggle_reminder({{ $current_task->id }})" href="#">{{ __('Remind me') }}</a>
                        @if($reminder_opened)
                        <ul>
                            <li>
                                <a wire:click.prevent="set_reminder({{ $current_task->id }}, '{{ today()->addDay()->toDateString() }}')" 
                                    href="#">{{ __('Tomarrow') }} {{ date('H') }}:00</a>
                            </li>
                            <li>
                    ...
                    @else
                        ...
                        @if($due_date_opened)
                            <ul>
                                ...
                                <li>
                                    <a wire:click.prevent="set_due_date({{ $current_task->id }}, '{{ today()->addWeek()->startOfWeek() }}')" 
                                        href="#">{{ __('Next Week') }}</a>
