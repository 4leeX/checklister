...
class CheckListController extends Controller
{
    ...
    {
        return view('admin.checklist_groups.checklists.create', compact('checklistGroup'));
    }
    ...
    {
        return view('admin.checklist_groups.checklists.edit', compact('checklistGroup', 'checklist'));
    }
